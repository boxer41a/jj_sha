...
extern EIF_TYPED_VALUE F797_3809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3812(EIF_REFERENCE);
extern void F797_8727(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F797_3809 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 3498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 3498);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800031F, 0,0); /* Result */
	{
...
EIF_TYPED_VALUE F797_3812 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 3499);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 3499);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) (ti4_1 <= ti4_2)) {
			...
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3184, dtype))(Current)).it_i4);
...
void F797_8727 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 796, Current, 0, 8726);
	RTSA(dtype);
	RTME(dtype, 0);
