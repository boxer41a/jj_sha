...
extern EIF_TYPED_VALUE F801_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F801_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 800, Current, 0, 0, 7605);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(800, Current, 7605);
	RTIV(Current, RTAL);
