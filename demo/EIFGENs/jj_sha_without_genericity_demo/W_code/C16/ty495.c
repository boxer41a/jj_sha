...
extern EIF_TYPED_VALUE F495_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F495_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 494, Current, 0, 0, 7600);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(494, Current, 7600);
	RTIV(Current, RTAL);
