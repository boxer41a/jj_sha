...
extern EIF_TYPED_VALUE F729_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F729_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 728, Current, 0, 0, 7603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(728, Current, 7603);
	RTIV(Current, RTAL);
