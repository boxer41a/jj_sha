...
EIF_TYPED_VALUE F150_2456 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 149, Current, 0, 0, 1852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(149, Current, 1852);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1830, 95))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 149, Current, 0, 0, 1853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(149, Current, 1853);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
