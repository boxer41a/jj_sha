...
extern EIF_TYPED_VALUE F437_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F437_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 436, Current, 0, 0, 7599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(436, Current, 7599);
	RTIV(Current, RTAL);
