...
extern EIF_TYPED_VALUE F946_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F946_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 945, Current, 0, 0, 7609);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(945, Current, 7609);
	RTIV(Current, RTAL);
