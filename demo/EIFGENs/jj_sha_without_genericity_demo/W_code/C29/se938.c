...
extern EIF_TYPED_VALUE F938_3230(EIF_REFERENCE);
...
EIF_TYPED_VALUE F938_3230 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 937, Current, 0, 0, 2869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(937, Current, 2869);
	RTIV(Current, RTAL);
	RTHOOK(1);
