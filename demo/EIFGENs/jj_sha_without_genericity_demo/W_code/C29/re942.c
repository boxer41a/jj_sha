...
extern EIF_TYPED_VALUE F942_3809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F942_3812(EIF_REFERENCE);
extern void F942_8727(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F942_3809 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 941, Current, 0, 0, 3510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(941, Current, 3510);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80003B0, 0,0); /* Result */
	{
...
EIF_TYPED_VALUE F942_3812 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 941, Current, 0, 0, 3511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(941, Current, 3511);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F942_8727 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 941, Current, 0, 8726);
	RTSA(dtype);
	RTME(dtype, 0);
