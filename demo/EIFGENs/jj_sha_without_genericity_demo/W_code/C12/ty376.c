...
extern EIF_TYPED_VALUE F376_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F376_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 375, Current, 0, 0, 7597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(375, Current, 7597);
	RTIV(Current, RTAL);
