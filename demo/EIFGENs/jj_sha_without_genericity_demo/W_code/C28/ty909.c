...
extern EIF_TYPED_VALUE F909_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F909_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 0, 0, 7608);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 7608);
	RTIV(Current, RTAL);
