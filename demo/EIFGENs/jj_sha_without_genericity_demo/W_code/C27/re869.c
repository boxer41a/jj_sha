...
extern EIF_TYPED_VALUE F869_3809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_3812(EIF_REFERENCE);
extern void F869_8727(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F869_3809 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 3504);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(868, Current, 3504);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000367, 0,0); /* Result */
	{
...
EIF_TYPED_VALUE F869_3812 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 3505);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(868, Current, 3505);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F869_8727 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 868, Current, 0, 8726);
	RTSA(dtype);
	RTME(dtype, 0);
