...
extern EIF_TYPED_VALUE F885_3268(EIF_REFERENCE);
extern void F885_8720(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F885_3268 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 884, Current, 0, 0, 2898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(884, Current, 2898);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F885_8720 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 884, Current, 0, 8719);
	RTSA(dtype);
	RTME(dtype, 0);
