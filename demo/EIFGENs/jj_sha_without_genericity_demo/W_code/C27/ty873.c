...
extern EIF_TYPED_VALUE F873_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F873_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 872, Current, 0, 0, 7607);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(872, Current, 7607);
	RTIV(Current, RTAL);
