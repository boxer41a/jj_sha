...
extern EIF_TYPED_VALUE F761_3809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F761_3812(EIF_REFERENCE);
extern void F761_8727(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F761_3809 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 3495);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 3495);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F761_3812 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 760, Current, 0, 0, 3496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 3496);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F761_8727 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 760, Current, 0, 8726);
	RTSA(dtype);
	RTME(dtype, 0);
