...
extern EIF_TYPED_VALUE F765_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F765_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 764, Current, 0, 0, 7604);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(764, Current, 7604);
	RTIV(Current, RTAL);
