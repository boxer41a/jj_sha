...
extern EIF_TYPED_VALUE F716_3282(EIF_REFERENCE);
extern void F716_8722(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F716_3282 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 715, Current, 0, 0, 2924);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(715, Current, 2924);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F716_8722 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 715, Current, 0, 8721);
	RTSA(dtype);
	RTME(dtype, 0);
