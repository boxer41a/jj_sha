...
extern EIF_TYPED_VALUE F837_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F837_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 836, Current, 0, 0, 7606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(836, Current, 7606);
	RTIV(Current, RTAL);
