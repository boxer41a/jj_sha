...
extern EIF_TYPED_VALUE F109_2301(EIF_REFERENCE);
...
RTOID (F109_2301)
EIF_TYPED_VALUE F109_2301 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 108, Current, 0, 0, 1706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(108, Current, 1706);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
