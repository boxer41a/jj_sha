...
static const EIF_TYPE_INDEX egt_0_1 [] = {0xFF01,268,0xFFFF};
static const EIF_TYPE_INDEX egt_1_1 [] = {0xFF01,290,0,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_1 [] = {0xFF01,268,0xFFFF};
static const EIF_TYPE_INDEX egt_10_1 [] = {0xFF01,268,0xFFFF};
