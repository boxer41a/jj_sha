...
extern void F15_617(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F15_618(EIF_REFERENCE);
extern EIF_TYPED_VALUE F15_619(EIF_REFERENCE);
...
void F15_617 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 14, Current, 0, 1, 293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(14, Current, 293);
	RTCC(arg1, 14, l_feature_name, 1, eif_new_type(263, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 614, 0xF800010F, 0); /* message */
	tr1 = RTLNSMART(RTWCT(614, dtype, Dftype(Current)).id);
	ur1 = RTCCL(arg1);
...
/* {SED_ERROR}.error */
EIF_TYPED_VALUE F15_618 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 14, Current, 0, 0, 294);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {SED_ERROR}.message */
EIF_TYPED_VALUE F15_619 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
