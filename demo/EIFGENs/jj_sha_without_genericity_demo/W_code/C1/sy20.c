...
extern EIF_TYPED_VALUE F20_660(EIF_REFERENCE);
extern void F20_8690(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F20_660 (EIF_REFERENCE Current)
{
	GTCX
...
void F20_8690 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 19, Current, 0, 8689);
	RTSA(Dtype(Current));
