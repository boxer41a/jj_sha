...
extern EIF_TYPED_VALUE F313_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F313_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 312, Current, 0, 0, 7595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(312, Current, 7595);
	RTIV(Current, RTAL);
