...
extern EIF_TYPED_VALUE F311_3809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F311_3812(EIF_REFERENCE);
extern void F311_8727(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F311_3809 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 310, Current, 0, 0, 3468);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(310, Current, 3468);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F311_3812 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 310, Current, 0, 0, 3469);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(310, Current, 3469);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F311_8727 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 310, Current, 0, 8726);
	RTSA(dtype);
	RTME(dtype, 0);
