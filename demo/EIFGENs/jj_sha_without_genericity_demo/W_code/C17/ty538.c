...
extern EIF_TYPED_VALUE F538_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F538_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 537, Current, 0, 0, 7601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(537, Current, 7601);
	RTIV(Current, RTAL);
