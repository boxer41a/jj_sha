...
extern EIF_TYPED_VALUE F362_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F362_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 361, Current, 0, 0, 7596);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(361, Current, 7596);
	RTIV(Current, RTAL);
