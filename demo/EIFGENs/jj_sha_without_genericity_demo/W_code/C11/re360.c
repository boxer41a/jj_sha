...
extern EIF_TYPED_VALUE F360_3809(EIF_REFERENCE);
extern EIF_TYPED_VALUE F360_3812(EIF_REFERENCE);
extern void F360_8727(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F360_3809 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 3471);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 3471);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F360_3812 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 3472);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 3472);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F360_8727 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 359, Current, 0, 8726);
	RTSA(dtype);
	RTME(dtype, 0);
