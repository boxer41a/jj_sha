...
extern EIF_TYPED_VALUE F673_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F673_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 672, Current, 0, 0, 7602);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(672, Current, 7602);
	RTIV(Current, RTAL);
