...
extern EIF_TYPED_VALUE F406_5773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F406_5773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 7598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 7598);
	RTIV(Current, RTAL);
