...
extern EIF_TYPED_VALUE F958_3268(EIF_REFERENCE);
extern void F958_8720(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F958_3268 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 957, Current, 0, 0, 2902);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(957, Current, 2902);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F958_8720 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 957, Current, 0, 8719);
	RTSA(dtype);
	RTME(dtype, 0);
