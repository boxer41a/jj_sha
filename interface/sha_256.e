note
	description: "[
		Calculates the SHA-256 multi-bit `digest' for a string `message'.
		Theses functions are specific for SHA-256 calculations.
...
feature {NONE} -- Anchors
	...
	digest_imp: detachable SHA_DIGEST_256
