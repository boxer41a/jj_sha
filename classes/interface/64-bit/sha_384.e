note
	description: "[
		Calculates the SHA-512 multi-bit `digest' for a string `message'.
		Theses functions are specific for SHA-512 calculations; other functions
		are in SHA_GENERATOR.
...
feature {NONE} -- Anchors
	...
	digest_imp: detachable SHA_384_DIGEST
